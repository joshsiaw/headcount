...
ActiveRecord::Schema.define(version: 20160415050447) do
  ...
  create_table "attendee_groups", force: :cascade do |t|
    t.string   "name"
    t.string   "description"
    t.datetime "created_at",  null: false
    t.datetime "updated_at",  null: false
  ...
  create_table "attendees", force: :cascade do |t|
    ...
    t.integer  "attendee_group_id"
  end

  add_index "attendees", ["attendee_category_id"], name: "index_attendees_on_attendee_category_id", using: :btree
  add_index "attendees", ["attendee_group_id"], name: "index_attendees_on_attendee_group_id", using: :btree
  ...
  add_index "reports", ["attendee_group_id"], name: "index_reports_on_attendee_group_id", using: :btree
